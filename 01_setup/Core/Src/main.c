...
/**
  ...
  * 231223:
  * LED_1 para errores
  * - Nuevo coomentario en la funcion fm_debug_msg_uart
  * - fm_debug_msg_uart transmite salto de linea en lugar de terminador nulo
  * - fm_debug_msg_uart intenta
  *
  *
  *
  ******************************************************************************
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  case 1:
		  // Envia un mensaje
		  //fm_debug_msg_uart(buffer_msg, sizeof(buffer_msg));
